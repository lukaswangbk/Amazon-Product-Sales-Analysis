...
rating_piechart = go.Pie(labels = label_rating,
                         ...
                         textfont = dict(size = 50, color = 'white'),
...
ax1.set_title("Average Star Rating and Comments Number in 2002-2015",fontsize='60')
...
# tmp_df[tmp_df["sales"]>=15].shape[0] / tmp_df.shape[0] 
# Finding the overall distribution of sales volumn data and decide the standard for "successs"
tmp_df["success"] = 0
tmp_df.loc[tmp_df.sales>=15,'success'] = 1
tmp_df.loc[tmp_df.sales <15,'success'] = 0
...
pos_words="good hair recommend time make work dryer wife thank great best without like well model style use power fast need"
wc = wordcloud = WordCloud(background_color = 'lightcyan', width = 2000, height = 2000)
wc.generate(pos_words)
plt.style.use('fivethirtyeight')
plt.figure(figsize=(20, 20))
